            ...
            <header className="header">
                <nav className="navbar">
                    ...
                    <ul className="nav-links">
                        <li>
                            <Link to="/user/home" className="nav-link" style={{textDecoration:"none",color:"rgb(153,153,153)"}} >Home</Link>
                        </li>
                        <li>
                            <Link to="/user/aboutus" style={{textDecoration:"none",color:"rgb(153,153,153)"}} className="nav-link">About</Link>
                        </li>
                        {/* Services dropdown */}
                        <li className="nav-item">
                            <a className="nav-link" id='nav-link2' style={{textDecoration:"none",color:"rgb(153,153,153)"}}  onMouseEnter={toggleDropdown}>Services</a>
                            {isDropdownOpen && (
                        ...
                        <li>
                            <Link to="/portfolio" style={{textDecoration:"none",color:"rgb(153,153,153)"}} className="nav-link">Portfolio</Link>
                        </li>
                        <li>
                            <Link to="/user/contact" style={{textDecoration:"none",color:"rgb(153,153,153)"}} className="nav-link">Contact Us</Link>
                        </li>
                    </ul>
                </nav>
            </header>
