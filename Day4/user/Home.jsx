...
function Home() {
    ...
    return (
        ...
        <div className="home">
            ...
            <p className='ex'>An experience</p>
            <p className='ex1'> to remember</p>
        </div>
        <div className='text' >
            ...
            <p> company connections, Fox Events has a flair for transforming bespoke spaces </p>
        ...
        <div style={{paddingTop:"80px",height:"600px",paddingBottom:"80px",alignItems:"center",alignContent:"center",width:"100%",backgroundColor:"",display:"flex"}}>
            <div style={{height:"100%",marginLeft:"10%", background:"white",width:"40%"}}>
                ...
                <button style={{backgroundColor:"black",color:"white"}}><Link to="/user/contact" style={{textDecoration:"none",color:"white"}} className="nav-link">GET IN TOUCH</Link></button>
            </div>
