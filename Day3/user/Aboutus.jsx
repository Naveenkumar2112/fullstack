...
const Aboutus=()=> {
    return (
        ...
        <div style={{background:"#a39f74",padding:"1%",marginTop:"5%",width:"300px",left:"38%",position:"relative"}}>
            <img src={img1} style={{width:"98%"}} alt="" />
        </div>
        <div className='text' >
        ...
        <div style={{paddingTop:"80px",height:"600px",paddingBottom:"80px",alignItems:"center",alignContent:"center",width:"100%",backgroundColor:"",display:"flex"}}>
            <div style={{height:"100%",marginLeft:"10%", background:"white",width:"40%"}}>
                ...
                <button style={{backgroundColor:"black",color:"white"}} ><Link to="/user/contact" style={{textDecoration:"none",color:"white"}}>GET IN TOUCH</Link></button>
            </div>
